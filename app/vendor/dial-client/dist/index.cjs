...
var ContactsBook = class {
  constructor(provider, config) {
    ...
    __publicField(this, "emitter", new EventEmitter3__default.default());
...
var LocalContactsBookProvider = class {
  constructor(options) {
    ...
    this.storage = (_b = options.storage) != null ? _b : core.IS_BROWSER ? new core.BrowserStorage() : new core.MemoryStorage();
  }
  async getAll() {
...
var DialClient = class {
  ...
  resolveConfig(config) {
    var _a, _b, _c, _d, _e;
    const network = (_a = config.network) != null ? _a : core.DEFAULT_NETWORK;
    const baseUrl = (_b = config.baseUrl) != null ? _b : core.API_BASE_URLS[network];
    return {
      apiKey: config.apiKey,
      baseUrl,
      timeout: (_c = config.timeout) != null ? _c : 3e4,
      debug: (_d = config.debug) != null ? _d : false,
      fetch: (_e = config.fetch) != null ? _e : core.getFetch()
    };
  }
  /**
...
/** SDK version */
__publicField(DialClient, "version", core.SDK_VERSION);
